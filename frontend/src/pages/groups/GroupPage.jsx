...
function GroupPage() {
  ...
  async function submitAssignment(event) {
    ...
    try {
      ...
      await Promise.all([...fileMaterials, ...linkMaterials].map((material) => addAssignmentMaterial(assignmentResponse.data.assignment_id, material)));
